...
import geoDataPAC from 'data/poa_customer_map_WPL.json';
import customerPointsPAC from 'data/geocoded_customers_WPL.json';
...
const siteIdToName = {
  ...
  57875: { name: 'WEL - Welshpool', Lat: -31.997305, Long: 115.927311 },
  57871: { name: 'WPL - Welshpool Self Storage', Lat: -31.9935134, Long: 115.9307236 }
};

const storesPAC = [
  { StoreName: "StoreLocal Welshpool", Addr: "41 Abernethy Rd, Belmont WA 6104", Lat: -31.997305, Long: 115.927311, StoreType: "Competitors" },
  { StoreName: "Welshpool Self Storage", Addr: "1 Babel Rd, Welshpool WA 6106", Lat: -31.9935134, Long: 115.9307236, StoreType: "Us" },
  { StoreName: "Storage King - Bentley", Addr: "17 John Street, Bentley WA 6102", Lat: -32.0000637, Long: 115.9213381, StoreType: "Competitors" },
  { StoreName: "National Storage Welshpool", Addr: "66-70 Adams Drive, Welshpool WA 6106", Lat: -31.9893836, Long: 115.9242493, StoreType: "Competitors" },
 
];

export default function MapWPL() {
  ...
  const [viewState, setViewState] = useState({
    latitude: siteIdToName['57871'].lat,
    longitude: siteIdToName['57871'].lng,
    zoom: 11
  });
  ...
  useEffect(() => {
    ...
    if (site) {
      setViewState(prev => ({ ...prev, latitude: -31.9935134, longitude: 115.9307236 }));
    }
  }, [siteId]);
